...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
...
80101ea8:	68 02 77 10 80       	push   $0x80107702
...
801035fc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  ...
  release(&ptable.lock);
80103602:	e8 59 0e 00 00       	call   80104460 <release>
...
80103633:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103636:	e8 75 0e 00 00       	call   801044b0 <memset>
...
80103658:	e8 03 0e 00 00       	call   80104460 <release>
  return 0;
...
8010367b:	e8 e0 0d 00 00       	call   80104460 <release>
...
801036d0:	e8 6b 0b 00 00       	call   80104240 <initlock>
}
...
8010374a:	68 dc 75 10 80       	push   $0x801075dc
...
80103791:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103797:	e8 54 0c 00 00       	call   801043f0 <popcli>
  return p;
}
...
80103855:	e8 56 0e 00 00       	call   801046b0 <safestrcpy>
  p->cwd = namei("/");
...
80103883:	e8 d8 0b 00 00       	call   80104460 <release>
}
...
801038b2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038b8:	e8 33 0b 00 00       	call   801043f0 <popcli>
{
  uint sz;
  struct proc *curproc = myproc();
...
80103933:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103939:	e8 b2 0a 00 00       	call   801043f0 <popcli>
  int i, pid;
  struct proc *np;
  struct proc *curproc = myproc();
...
801039d1:	e8 da 0c 00 00       	call   801046b0 <safestrcpy>
...
801039f3:	e8 68 0a 00 00       	call   80104460 <release>
...
80103aa9:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
     // cprintf("Process %s with pid %d running\n", p->name, p->pid);
      swtch(&(c->scheduler), p->context);
80103ab0:	e8 56 0c 00 00       	call   8010470b <swtch>
      switchkvm();
...
80103ad8:	e8 83 09 00 00       	call   80104460 <release>
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103af5:	e8 06 08 00 00       	call   80104300 <pushcli>
  c = mycpu();
80103afa:	e8 e1 fb ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103aff:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b05:	e8 e6 08 00 00       	call   801043f0 <popcli>
sched(void)
{
  int intena;
...
80103b12:	e8 a9 07 00 00       	call   801042c0 <holding>
...
80103b53:	e8 b3 0b 00 00       	call   8010470b <swtch>
  mycpu()->intena = intena;
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103bb9:	e8 42 07 00 00       	call   80104300 <pushcli>
  c = mycpu();
80103bbe:	e8 1d fb ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103bc3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103bc9:	e8 22 08 00 00       	call   801043f0 <popcli>
{
  struct proc *curproc = myproc();
  struct proc *p;
  int fd;
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103cf1:	e8 0a 06 00 00       	call   80104300 <pushcli>
  c = mycpu();
80103cf6:	e8 e5 f9 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103cfb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d01:	e8 ea 06 00 00       	call   801043f0 <popcli>
// Give up the CPU for one scheduling round.
void
yield(void)
{
...
80103d19:	e8 42 07 00 00       	call   80104460 <release>
}
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103d3f:	e8 bc 05 00 00       	call   80104300 <pushcli>
  c = mycpu();
80103d44:	e8 97 f9 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103d49:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103d4f:	e8 9c 06 00 00       	call   801043f0 <popcli>
void
sleep(void *chan, struct spinlock *lk)
{
  struct proc *p = myproc();
...
80103d78:	e8 e3 06 00 00       	call   80104460 <release>
  }
  // Go to sleep.
  p->chan = chan;
...
80103d9a:	e8 c1 06 00 00       	call   80104460 <release>
    acquire(lk);
...
myproc(void) {
  ...
  struct proc *p;
  pushcli();
80103df5:	e8 06 05 00 00       	call   80104300 <pushcli>
  c = mycpu();
80103dfa:	e8 e1 f8 ff ff       	call   801036e0 <mycpu>
  p = c->proc;
80103dff:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103e05:	e8 e6 05 00 00       	call   801043f0 <popcli>
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
80103eb3:	e8 a8 05 00 00       	call   80104460 <release>
        return pid;
...
80103ecc:	e8 8f 05 00 00       	call   80104460 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  wakeup1(chan);
  release(&ptable.lock);
80103f31:	e9 2a 05 00 00       	jmp    80104460 <release>
...
80103f84:	e8 d7 04 00 00       	call   80104460 <release>
      return 0;
...
80103fb0:	e8 ab 04 00 00       	call   80104460 <release>
  return -1;
...
80103feb:	68 80 75 10 80       	push   $0x80107580
...
80104018:	8b 14 85 04 76 10 80 	mov    -0x7fef89fc(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
...
80104055:	e8 06 02 00 00       	call   80104260 <getcallerpcs>
...
8010409d:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
801040a2:	e8 99 02 00 00       	call   80104340 <acquire>
cprintf("name \t pid \t state \n");
801040a7:	c7 04 24 6d 75 10 80 	movl   $0x8010756d,(%esp)
801040ae:	e8 ad c5 ff ff       	call   80100660 <cprintf>
801040b3:	83 c4 10             	add    $0x10,%esp
801040b6:	eb 18                	jmp    801040d0 <cps+0x40>
801040b8:	90                   	nop
...
801040c0:	83 f8 04             	cmp    $0x4,%eax
801040c3:	74 4b                	je     80104110 <cps+0x80>
801040c5:	83 c3 7c             	add    $0x7c,%ebx
// Enable interrupts on this processor.
sti();
// Loop over process table looking for process with pid.
acquire(&ptable.lock);
cprintf("name \t pid \t state \n");
for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040c8:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
801040ce:	74 27                	je     801040f7 <cps+0x67>
if ( p->state == SLEEPING )
801040d0:	8b 43 a0             	mov    -0x60(%ebx),%eax
801040d3:	83 f8 02             	cmp    $0x2,%eax
801040d6:	75 e8                	jne    801040c0 <cps+0x30>
cprintf("%s \t %d  \t SLEEPING \n ", p->name, p->pid );
801040d8:	83 ec 04             	sub    $0x4,%esp
801040db:	ff 73 a4             	pushl  -0x5c(%ebx)
801040de:	53                   	push   %ebx
801040df:	68 82 75 10 80       	push   $0x80107582
801040e4:	83 c3 7c             	add    $0x7c,%ebx
801040e7:	e8 74 c5 ff ff       	call   80100660 <cprintf>
...
cprintf("name \t pid \t state \n");
for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040ef:	81 fb c0 4c 11 80    	cmp    $0x80114cc0,%ebx
801040f5:	75 d9                	jne    801040d0 <cps+0x40>
if ( p->state == SLEEPING )
cprintf("%s \t %d  \t SLEEPING \n ", p->name, p->pid );
else if ( p->state == RUNNING )
cprintf("%s \t %d  \t RUNNING \n ", p->name, p->pid );
...
801040ff:	e8 5c 03 00 00       	call   80104460 <release>
return 22;
}
80104104:	b8 16 00 00 00       	mov    $0x16,%eax
80104109:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010410c:	c9                   	leave  
8010410d:	c3                   	ret    
...
80104113:	ff 73 a4             	pushl  -0x5c(%ebx)
80104116:	53                   	push   %ebx
80104117:	68 99 75 10 80       	push   $0x80107599
8010411c:	e8 3f c5 ff ff       	call   80100660 <cprintf>
80104121:	83 c4 10             	add    $0x10,%esp
80104124:	eb 9f                	jmp    801040c5 <cps+0x35>
...
8010413a:	68 1c 76 10 80       	push   $0x8010761c
...
801042e3:	e8 f8 f3 ff ff       	call   801036e0 <mycpu>
...
80104374:	e8 67 f3 ff ff       	call   801036e0 <mycpu>
getcallerpcs(void *v, uint pcs[])
{
  uint *ebp;
  int i;
...
801043d3:	e8 08 f3 ff ff       	call   801036e0 <mycpu>
...
801043e3:	68 27 76 10 80       	push   $0x80107627
...
801043fb:	75 52                	jne    8010444f <popcli+0x5f>
  ...
  if(--mycpu()->ncli < 0)
801043fd:	e8 de f2 ff ff       	call   801036e0 <mycpu>
...
80104415:	e8 c6 f2 ff ff       	call   801036e0 <mycpu>
...
80104429:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104430:	e8 ab f2 ff ff       	call   801036e0 <mycpu>
...
80104445:	68 46 76 10 80       	push   $0x80107646
...
80104452:	68 2f 76 10 80       	push   $0x8010762f
...
80104471:	68 4d 76 10 80       	push   $0x8010764d
...
80104483:	e8 58 f2 ff ff       	call   801036e0 <mycpu>
...
80104727:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010472a:	e8 51 f0 ff ff       	call   80103780 <myproc>
...
801047c5:	e8 b6 ef ff ff       	call   80103780 <myproc>
...
{
  struct proc *curproc = myproc();
801047d6:	e8 a5 ef ff ff       	call   80103780 <myproc>
...
80104818:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010481b:	e8 60 ef ff ff       	call   80103780 <myproc>
...
801048b4:	53                   	push   %ebx
  int num;
  struct proc *curproc = myproc();
801048b5:	e8 c6 ee ff ff       	call   80103780 <myproc>
...
801048c5:	83 fa 15             	cmp    $0x15,%edx
801048c8:	77 1e                	ja     801048e8 <syscall+0x38>
801048ca:	8b 14 85 80 76 10 80 	mov    -0x7fef8980(,%eax,4),%edx
...
801048f0:	68 55 76 10 80       	push   $0x80107655
...
80104a54:	68 f8 76 10 80       	push   $0x801076f8
...
80104a6c:	68 f7 76 10 80       	push   $0x801076f7
...
80104a81:	68 eb 76 10 80       	push   $0x801076eb
...
80104a8e:	68 fa 76 10 80       	push   $0x801076fa
...
80104a9b:	68 dc 76 10 80       	push   $0x801076dc
...
80104ad4:	e8 a7 ec ff ff       	call   80103780 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80104b3b:	e8 40 ec ff ff       	call   80103780 <myproc>
...
80104c73:	78 2b                	js     80104ca0 <sys_close+0x40>
    return -1;
  myproc()->ofile[fd] = 0;
80104c75:	e8 06 eb ff ff       	call   80103780 <myproc>
...
80104ead:	58                   	pop    %eax
80104eae:	5a                   	pop    %edx
80104eaf:	68 f8 76 10 80       	push   $0x801076f8
...
80104ec8:	68 f7 76 10 80       	push   $0x801076f7
...
8010501d:	68 1c 77 10 80       	push   $0x8010771c
...
8010502a:	68 2e 77 10 80       	push   $0x8010772e
...
80105037:	68 0a 77 10 80       	push   $0x8010770a
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801050d3:	e8 a8 e6 ff ff       	call   80103780 <myproc>
801050d8:	90                   	nop
...
801052a5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801052a8:	e8 d3 e4 ff ff       	call   80103780 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
80105469:	e8 12 e3 ff ff       	call   80103780 <myproc>
...
fdalloc(struct file *f)
{
  int fd;
  struct proc *curproc = myproc();
801054b2:	e8 c9 e2 ff ff       	call   80103780 <myproc>
...
{
return cps();
80105504:	e9 87 eb ff ff       	jmp    80104090 <cps>
...
80105605:	e8 36 ed ff ff       	call   80104340 <acquire>
  ticks0 = ticks;
...
8010569c:	e8 9f ec ff ff       	call   80104340 <acquire>
  xticks = ticks;
...
80105739:	68 3d 77 10 80       	push   $0x8010773d
...
801057d0:	ff 24 85 e4 77 10 80 	jmp    *-0x7fef881c(,%eax,4)
...
80105835:	68 a0 77 10 80       	push   $0x801077a0
...
8010591f:	68 48 77 10 80       	push   $0x80107748
...
80105961:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105964:	e8 47 ef ff ff       	call   801048b0 <syscall>
    if(myproc()->killed)
...
80105998:	e8 a3 e9 ff ff       	call   80104340 <acquire>
      ticks++;
      wakeup(&ticks);
...
80105adf:	bb 64 78 10 80       	mov    $0x80107864,%ebx
...
801068e4:	0f 84 c4 00 00 00    	je     801069ae <switchuvm+0xee>
  ...
  pushcli();
801068ea:	e8 11 da ff ff       	call   80104300 <pushcli>
...
8010699b:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
8010699c:	e9 4f da ff ff       	jmp    801043f0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
...
801069a4:	68 72 78 10 80       	push   $0x80107872
...
801069b1:	68 9d 78 10 80       	push   $0x8010789d
...
801069be:	68 88 78 10 80       	push   $0x80107888
...
80106a39:	68 b1 78 10 80       	push   $0x801078b1
...
80106aed:	68 cb 78 10 80       	push   $0x801078cb
...
80106afa:	68 6c 79 10 80       	push   $0x8010796c
...
80106b53:	e8 58 d9 ff ff       	call   801044b0 <memset>
...
80106b91:	68 e9 78 10 80       	push   $0x801078e9
...
80106bc3:	68 01 79 10 80       	push   $0x80107901
...
80106cac:	68 1d 79 10 80       	push   $0x8010791d
...
80106d7f:	68 2e 79 10 80       	push   $0x8010792e
...
80106e62:	68 52 79 10 80       	push   $0x80107952
...
80106e6f:	68 38 79 10 80       	push   $0x80107938
